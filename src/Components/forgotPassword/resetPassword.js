...
class ResetPassword extends Component {
  ...
  handleResetPassword = async (e) => {
    ...
    // console.log("13818239 handleResetPassword", {props: this.props, getFieldValues: getFieldsValue(), validateFields: validateFields((err, value) => {
    //     console.log("13818239 err, value ", {err, value});
    //     }).then(res => {
    //         console.log("13818239 res ---> ", res);
    //     })
    // });
    // validateFields((err, { new_password, confirm_password }) => {
    //     if(err) {
    //         console.log("128312839 validateFields err --> ", {err});
    //     }
    //     console.log("128312839 validateFields --> ", {err, new_password, confirm_password});
    // });
    //     console.log("13818239 err ---> ", err);
    //     if (!err) {
    //         try {
    //             console.log("err ---> ", {new_password, confirm_password});
        ...
        <div className="hp100 wp75">
          ...
          <div className="center-container">
            <div className="form-container-reset">
              ...
              <LegacyForm onSubmit={handleResetPassword} className="login-form">
                <FormItem
...
export default LegacyForm.create()(ResetPassword);
