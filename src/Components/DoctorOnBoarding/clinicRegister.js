...
class ClinicRegister extends Component {
    ...
    fetchData = async () => {
        ...
        await getDoctorProfileDetails(url.length > 4 ? url[url.length - 1] : 0);
        ...
        const {onBoarding = {}, doctor_clinics = {}} = this.props;
        let clinicsKeys = [];
        let clinics = {};
                        ...
                        <div key={key}>
                            ...
                            <div
                                className={`form-input-border ${
                                    locationToDisplay ? "active-grey-location" : "default-grey"
                                } pointer`}
                                onClick={this.setModalVisible(key)}
                            >
                                <div
                                    className={
                                        locationToDisplay ? "active-grey-location" : "default-grey"
                            ...
                            {Object.keys(timings).length && isClinicOpen ? (
                                ...
                                <div
                                    className={`form-input-timing default-grey pointer`}
                                    onClick={this.setModalTimingVisible(key)}
                                >
            ...
            <div className="form-block">
                <div className="flex justify-space-between align-center direction-row">
                    <div className="form-category-headings">
                        {this.formatMessage(messages.clinic)}
                    </div>
                    <div
    ...
    render() {
        ...
        if (clinicKeyOfModalTiming) {
            const {timings = {}, daySelected = {}} =
            clinics[clinicKeyOfModalTiming] || {};
            currClinicTimings = timings;
            currClinicDaySelect = daySelected;
        }
        let timingForModal =
            clinicKeyOfModalTiming && Object.keys(currClinicTimings).length
                ? currClinicTimings
                : dayTimings;
            ...
            <Fragment>
                ...
                <div className="registration-container">
                    ...
                    <div className="registration-body">
                        ...
                        <div className="flex mb100">{this.renderClinicForm()}</div>
                    </div>
                    <div className="footer">
                        ...
                        <div className={"footer-text-active"} onClick={this.onNextClick}>
                            {this.formatMessage(messages.finish)}
                        </div>
                    </div>
                </div>
                ...
                <LocationModal
                    ...
                    location={
                        clinicKeyOfModal && clinics[clinicKeyOfModal]
                            ? clinics[clinicKeyOfModal].location
                            : ""
                    }
                />
                {timingsVisible && (
                    <TimingModal
                        ...
                        handleCancel={this.handleCancelTiming}
                        handleOk={this.handleOkTiming}
