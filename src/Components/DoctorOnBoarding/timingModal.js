...
import {Button, Checkbox, message, Modal, TimePicker} from "antd";
    ...
    handleTimeSelect =
        ({day, key, type}) =>
            (time) => {
                ...
                if (type === START_TIME) {
                    startTime = moment().hour(hour24).minute(minute);
                    endTime = moment().hour(hour24).minute(minute).add(30, "minutes");
                } else {
                    if (startTime) {
                        const timeDifference = moment(startTime).diff(
                            moment().hour(hour24).minute(minute),
                            "minute"
                        );
                        if (timeDifference > 0) {
                            ...
                            endTime = moment().hour(hour24).minute(minute);
                        }
                    } else {
                        endTime = moment().hour(hour24).minute(minute);
                    }
                                        ...
                                        return (
                                            <div key={tKey} className="flex mb10">
                                                ...
                                                <div className="flex direction-row align-center flex-grow-1">
                                                    <div className="flex direction-column wp100">
                                                        <div
                                                            className="flex wp100 align-center justify-space-between fs14 mt8 mb8">
