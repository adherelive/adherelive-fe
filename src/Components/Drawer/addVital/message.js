...
export default defineMessages({
    ...
    title: {
        ...
        description: "",
        defaultMessage: "New Vital",
    },
    titleInner: {
        id: "medication_reminder.modal.titleInner",
        description: "",
        defaultMessage: "Medication",
    },
    add_button_text: {
        id: "medication_reminder.drawer.add.button.text",
        description: "",
        defaultMessage: "Add",
    },
    submit_button_text: {
        id: "medication_reminder.drawer.submit.button.text",
        description: "",
